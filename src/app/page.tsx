...
export async function generateMetadata(): Promise<Metadata> {
  const c = CONTENIDO_INICIO[await obtenerIdioma()];
  return {
    title: { absolute: c.meta.titulo },
    description: c.meta.descripcion,
    alternates: { canonical: "/" },
    openGraph: { title: c.meta.titulo, description: c.meta.descripcion, url: URL_SITIO },
    twitter: { title: c.meta.titulo, description: c.meta.descripcion },
  };
}
          ...
          <div className="mx-auto grid max-w-6xl gap-10 px-4 pt-12 pb-6 sm:pt-20 lg:grid-cols-[minmax(0,7fr)_minmax(0,4fr)] lg:items-end">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link href="/registro" className={clasesBoton("primario", "grande")}>
                  {c.hero.cta}
                </Link>
        ...
        <Seccion titulo={c.empezar.titulo} className="bg-superficie">
          ...
          <div className="relative mt-14 overflow-hidden rounded-[28px] bg-dia-3 px-6 py-10 sm:px-12 sm:py-14">
            ...
            <div className="flex flex-col items-start gap-6 lg:flex-row lg:items-center lg:justify-between">
              ...
              <Link href="/registro" className={`${clasesBoton("primario", "grande")} w-full sm:w-auto`}>
                {c.hero.cta}
              </Link>
            </div>
          </div>
