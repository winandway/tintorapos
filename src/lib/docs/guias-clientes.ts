      ...
      bloques: [
        ...
        { t: "h2", texto: "Qué ve el cliente" },
        {
          ...
          items: [
            ...
            "**Se actualiza sola**: si el cliente deja la página abierta, cada medio minuto (y al volver a ella) vuelve a preguntar. Cuando marcas la ropa como lista, lo ve sin recargar.",
          ],
        },
      ...
      bloques: [
        ...
        { t: "h2", texto: "What the customer sees" },
        {
          ...
          items: [
            ...
            "**It updates on its own**: if the customer leaves the page open, it checks again every half minute (and whenever they come back to it). When you mark the clothes ready, they see it without reloading.",
          ],
        },
